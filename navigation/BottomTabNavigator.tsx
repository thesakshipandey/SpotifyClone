...
import { Ionicons, Foundation, FontAwesome5, Feather } from '@expo/vector-icons';
  ...
  return (
    <BottomTab.Navigator
      ...
      <BottomTab.Screen
        ...
        component={TabTwoNavigator}
        options={{
          tabBarIcon: ({ color }) => <Feather name="bar-chart-2" size={30} style={{ marginBottom: -3 }} color={color} />,
        }}
      />
      <BottomTab.Screen
        name="Premium"
